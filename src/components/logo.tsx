 ...
 * A plain <a> so a click always reloads the home page, clearing any scan result.
 */
export function Logo() {
  return (
    <a href="/" className="group inline-flex items-center gap-2 font-display text-[1.2rem] sm:text-[1.35rem] leading-none whitespace-nowrap font-extrabold tracking-tight" aria-label="Get Shortlisted — home">
